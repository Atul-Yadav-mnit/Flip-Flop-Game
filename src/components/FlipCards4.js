...
function FlipCards4() {
    ...
    const displayCards = Cards.initial === true ?
        Cards.cards.map((card) => {
            return (
                <div className="col-2 ml-4 mr-4 mt-3" style={{ border: "red 2px solid", height: "100px" }}>
                    <Card id={card.id}>
        ...
        Cards.cards.map((card) => {
            if (card.isclicked === true) {
                return (
                    <div className="col-2 ml-4 mr-4 mt-3" style={{ height: "100px" }}>
                        <Card id={card.id}>
                            <CardTitle>{card.value}</CardTitle>
                        </Card>
                    </div>
                ...
                return (
                    <div className="col-2 ml-4 mr-4 mt-3" style={{ height: "100px" }} onClick={() => handleCardClick(card)}>
